...
3. A compliant implementation **applies** blocks from subscribed covens to the user's local filesystem, translating them to the format expected by their agent.
